 ...
 */
export default function TransferCopyModal({ apiUrl, transferType, formOpen, setFormOpen, selectedRows }) {
        ...
        <StyledModal open={formOpen} onClose={() => { setFormOpen(false) }}>
            ...
            >
                ...
                <Box component="form" onSubmit={handleCopy} noValidate sx={{ mt: 1 }}>
                    <Typography>Are you sure you want to copy selected {transferType === TransferTypes.EXPENSE ? 'Expenses' : 'Incomes'}?</Typography>
