 ...
 */
export default function TransferBulkDeleteModal({ apiUrl, transferType, formOpen, setFormOpen, selectedRows }) {
        ...
        <StyledModal open={formOpen} onClose={() => { setFormOpen(false) }}>
            ...
            >
                <Typography variant="h6" component="h2" textAlign="center">
                    Delete {transferType === TransferTypes.INCOME ? 'Incomes' : 'Expenses'}
                </Typography>
                <Box component="form" onSubmit={handleDelete} noValidate sx={{ mt: 1 }}>
                    <Typography>Are you sure you want to delete selected {transferType === TransferTypes.EXPENSE ? 'Expenses' : 'Incomes'}?</Typography>
