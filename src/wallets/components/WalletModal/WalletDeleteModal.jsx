...
/**
 * WalletDeleteModal component for displaying delete Wallet form.
 * @param {object} props
 ...
 * @param {string} [props.deletedWalletId] - Wallet object to be deleted id value.
 * @param {function} [props.setDeletedWalletId] - Setter for deletedWalletId value.
 */
export default function WalletDeleteModal({
  ...
  const handleDelete = async () => {
    try {
      await deleteApiObject(apiUrl, deletedWalletId);
