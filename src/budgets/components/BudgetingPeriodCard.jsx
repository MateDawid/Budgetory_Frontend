        ...
        >
          ...
          >
            ...
            <Typography fontSize={12} color="secondary">
              {object.incomes_sum}&nbsp;{contextBudgetCurrency}
            </Typography>
          </Stack>
          ...
          >
            ...
            <Typography fontSize={12} color="secondary">
              {object.expenses_sum}&nbsp;{contextBudgetCurrency}
            </Typography>
          </Stack>
        </Stack>
        <Divider sx={{ width: '100%', mb: 1, mt: 1 }} />
