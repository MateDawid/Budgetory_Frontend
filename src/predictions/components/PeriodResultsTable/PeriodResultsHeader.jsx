    ...
    return (
        <TableRow>
            ...
            <TableCell align='center'>
                <Stack direction="row" spacing={1} display="flex" alignItems="center" justifyContent="center">
                    ...
                    <Tooltip
                        title={
                            <>
                                <b>Total Expense Predictions</b><br />
                                compared to<br />
            ...
            <TableCell align='center'>
                <Stack direction="row" spacing={1} display="flex" alignItems="center" justifyContent="center">
                    <Typography variant="body2" fontWeight="bold">
                        Funds&nbsp;left&nbsp;<br/>for&nbsp;Predictions
                    </Typography>
                    <Tooltip
                        title={"Funds available in Period that can be used to plan Expenses in Predictions."}
                        placement="top">
                        <HelpOutlineIcon />
                    </Tooltip>
                </Stack>
            ...
            <TableCell align='center'>
                <Stack direction="row" spacing={1} display="flex" alignItems="center" justifyContent="center">
                    <Typography variant="body2" fontWeight="bold">
                        Funds&nbsp;left&nbsp;<br/>for&nbsp;predicted&nbsp;Expenses
                    </Typography>
                    <Tooltip
                        title={"Predicted funds left that can be spent for Expenses in Period."}
                        placement="top">
                        <HelpOutlineIcon />
                    </Tooltip>
                </Stack>
