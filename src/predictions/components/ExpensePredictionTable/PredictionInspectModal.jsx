import { Typography, Box, TableContainer, Paper, Table, TableBody, TableCell, TableHead, TableRow } from "@mui/material";
...
export default function PredictionInspectModal({ periodId, categoryId, inspectOpen, setInspectOpen }) {
            ...
            >
                ...
                <Box sx={{ mt: 1, display: 'flex', justifyContent: 'center' }}>
                    {expenses.length > 0 ?
                        <Paper sx={{ width: '100%', overflow: 'hidden' }}>
                            <TableContainer sx={{ 
                                ...
                                <Table stickyHeader aria-label="sticky table">
                                    <TableHead>
                                        <TableRow>
                                            <TableCell align='center' sx={{ fontWeight: 'bold', minWidth: 100 }}>Date</TableCell>
                                            <TableCell align='center' sx={{ fontWeight: 'bold', minWidth: 100 }}>Value</TableCell>
                                    ...
                                    <TableBody>
                                        {expenses.map((row) => (
                                            <TableRow key={row.name}>
                                                ...
                                                <TableCell align='center' sx={{ fontWeight: 'bold' }}>{row.value}&nbsp;{contextBudgetCurrency}</TableCell>
                        ...
                        :
                        <Typography color='primary' fontWeight="bold">No Expenses found.</Typography>
                        }
                </Box>
            </Box>
        </StyledModal>
